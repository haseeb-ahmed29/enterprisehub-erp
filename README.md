...
A database-backed ASP.NET Core MVC application for managing enterprisehub erp workflows.

## Purpose

This repository was created as a practical project to explore the design and implementation of **EnterpriseHub ERP**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
